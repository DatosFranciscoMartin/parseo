...
def procesar_archivo(archivo, directorio_salida, origen_fichero):
    ...
    try:
        ...
        elif os.path.exists(r'C:\Users\franciscojavier.mart\Documents\Repos\parseo\programas\RTVE-UHD\Ejecutor\cf\config.conf'):
            config.read(r'C:\Users\franciscojavier.mart\Documents\Repos\parseo\programas\RTVE-UHD\Ejecutor\cf\config.conf')
        else:
        ...
        for event, diccionario_interno in eventos.items():
            ...
            if diccionario_interno['TIPOREG'] == "1":
                ...
                if diccionario_interno['SUBTITULADO'] == "S" or diccionario_interno['SUBTITULADO'] == "I":
                    ...
                    media_subtitle = ET.SubElement(properties_feature, "media")
                ...
                if diccionario_interno["TITIPELEME"] in ["A", "E", "P"]:
                    ...
                    # Generamos el arbol xml que va a colgar de childevents UHD
                    event_child_1 = ET.SubElement(child_event, "event")
                    event_child_1.set("type", "DolphinCG")
                ...
                if grafico_secundario != "":
                    ...
                    event_child_2.set("type", "DolphinCG")
                ...
                for clave, diccionario_tipo_3 in diccionario_interno.items():
                    if clave.startswith('Tipo3_'):
                        ...
                        event_child_5.set("type", "DolphinCG")
